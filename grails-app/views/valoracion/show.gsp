...
<div id="show-valoracion" class="content scaffold-show" role="main">
        ...
        <g:if test="${valoracionInstance?.solicitud}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="solicitud-label"><g:link controller="solicitud"
                                                                                       action="show"
                                                                                       id="${valoracionInstance?.solicitud?.id}">${valoracionInstance?.solicitud?.encodeAsHTML()}</g:link></span>
        ...
        <g:if test="${valoracionInstance?.l1antiguedad}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="l1antiguedad-label"><g:fieldValue
                        bean="${valoracionInstance}" field="l1antiguedad"/></span>
        ...
        <g:if test="${valoracionInstance?.l1centrosEscolares}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="l1centrosEscolares-label"><g:fieldValue
                        bean="${valoracionInstance}" field="l1centrosEscolares"/></span>
    ...
    <li class="fieldcontain">
        ...
        <g:if test="${valoracionInstance?.l1objetivosGK}">
            <li class="fieldcontain">
        ...
        <g:if test="${valoracionInstance?.l1lenguajeNoSexista}">
            <li class="fieldcontain">
        ...
        <g:if test="${valoracionInstance?.l1lenguajeDeGenero}">
            <li class="fieldcontain">
        ...
        <g:if test="${valoracionInstance?.l1representacionFemeninaJunta}">
            <li class="fieldcontain">
        ...
        <g:if test="${valoracionInstance?.l1inmigracion}">
            <li class="fieldcontain">
        ...
        <g:if test="${valoracionInstance?.l1personasDiscapacidad}">
            <li class="fieldcontain">
        ...
        <g:if test="${valoracionInstance?.importeConcedido}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="importeConcedido-label">
                    <g:formatNumber number="${valoracionInstance.importeConcedido}" type="currency"
    ...
    <g:form url="[resource: valoracionInstance, action: 'delete']" method="DELETE">
        <fieldset class="buttons">
            <g:link class="edit" action="edit" resource="${valoracionInstance}"><g:message
