...
<div class="fieldcontain ${hasErrors(bean: solicitudInstance, field: 'tipoSolicitud', 'error')} required">
	...
	<g:select name="tipoSolicitud" from="${solicitudInstance.constraints.tipoSolicitud.inList}" required="" value="${solicitudInstance?.tipoSolicitud}" valueMessagePrefix="solicitud.tipoSolicitud"/>
...
<div class="fieldcontain ${hasErrors(bean: solicitudInstance, field: 'linea', 'error')} required">
	...
	<g:select name="linea" from="${solicitudInstance.constraints.linea.inList}" required="" value="${fieldValue(bean: solicitudInstance, field: 'linea')}" valueMessagePrefix="solicitud.linea"/>
...
<div class="fieldcontain ${hasErrors(bean: solicitudInstance, field: 'importeSolicitado', 'error')} required">
	...
	<g:field name="importeSolicitado" value="${fieldValue(bean: solicitudInstance, field: 'importeSolicitado')}" required=""/>
...
<div class="fieldcontain ${hasErrors(bean: solicitudInstance, field: 'importeSolicitadoOtros', 'error')} ">
	...
	<g:field name="importeSolicitadoOtros" value="${fieldValue(bean: solicitudInstance, field: 'importeSolicitadoOtros')}"/>
...
<li class="add">
<g:link controller="balance" action="create" params="['solicitud.id': solicitudInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'balance.label', default: 'Balance')])}</g:link>
</li>
</ul>
...
<li class="add">
<g:link controller="memoria" action="create" params="['solicitud.id': solicitudInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'memoria.label', default: 'Memoria')])}</g:link>
</li>
</ul>
...
<li class="add">
<g:link controller="valoracion" action="create" params="['solicitud.id': solicitudInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'valoracion.label', default: 'Valoracion')])}</g:link>
</li>
</ul>
